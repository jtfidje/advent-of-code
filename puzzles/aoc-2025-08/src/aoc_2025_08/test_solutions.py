...
from aoc_2025_08 import DATA_PATH, cleaned, part_1, part_2

# ------------------------------

answers_example_1 = [40]
answers_example_2 = [25272]

answer_part_1 = 42840
answer_part_2 = 170629052
...
def test_solve_1_run_example(i: int):
    answer = part_1.solve(DATA_PATH / f"example_1_{i + 1}.txt", num_pairs=10)
    if answer is None:
        assert True
    else:
...
def test_solve_1_run_input():
    assert part_1.solve(DATA_PATH / "input.txt", num_pairs=1_000) == answer_part_1
...
def test_solve_1_cleaned_example(i: int):
    assert (
        cleaned.solve_1(DATA_PATH / f"example_1_{i + 1}.txt", num_pairs=10)
        == answers_example_1[i]
    )
...
def test_solve_1_cleaned_input():
    assert cleaned.solve_1(DATA_PATH / "input.txt", num_pairs=1_000) == answer_part_1
